"""
This is an example script, showing how the code is used in this project. This particular script was used to perform random grid search of one of the self-developed CNN models.
Note that this script has dependencies which cannot be found in the repository.
"""
...
base_dir = "Path to root folder of the project"
